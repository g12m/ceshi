...
class SettingController extends AdminBaseController
{
    ...
    public function sitePost()
    {
        if ($this->request->isPost()) {
            ...
            $server_settings = $this->request->param('server_settings/a');
            cmf_set_option('server_settings', $server_settings);
            // 短信
            $sms_settings=$this->request->param('sms_settings/a');
             cmf_set_option('sms_setting',$sms_settings);
